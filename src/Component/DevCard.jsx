  ...
  return (
    <div className="flex flex-col p-2  gap-2 hover:shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] cursor-pointer md:p-4 rounded-2xl transition ease-in-out delay-100 duration-200">
          <div className="flex flex-row  items-center gap-2 ">
             <img  src={`img/${devinfo.icon}`} className=" scale-50 lg:scale-95 dark:invert " alt={devinfo.title} />
          <h4 className="font-normal  xl:w-8/12 text-xs md:text-md xl:text-lg  ">{devinfo.title}</h4>
          </div>
